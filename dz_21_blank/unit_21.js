...
function t8() {
    let color = a8=['red', 'green', 'blue', 'orange', 'pink', 'yellow'];
    document.querySelector('.div-8').style.background = color[Math.floor(Math.random() * color.length)];
}
...
function t11(e) {
    document.querySelector('.out-11').innerHTML = e.changedTouches[0].radiusX + '<br>' + e.changedTouches[0].radiusY;
}
...
const imageBig = document.querySelector('.div-12-max');
...
function nextFunction() {
    if(count < images.length - 1) {
        ...
        imgNum = count + 1;
        imageBig.innerHTML = `<img src="img/${imgNum}.png" alt="" class="img-12-max">`;
    }
    else {
        count = 0;
