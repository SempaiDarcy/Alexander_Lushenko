...
function t2() {
    ...
    xhttp.onreadystatechange = function () {
        if (this.readyState === 4 && this.status === 200) {
            t2_out(this.responseText);
        }
    };
    xhttp.open(
        "GET",
        "http://getpost.itgid.info/index2.php?auth=7859d9d42a8834141d529577207c9596&action=2&name=Akbar",
        true
    );
    xhttp.send();
}

function t2_out(data) {
...
function t3() {
    ...
    xhttp.onreadystatechange = function () {
        if (this.readyState === 4 && this.status === 200) {
            t3_out(this.responseText);
        }
    };
    xhttp.open(
        "GET",
        "http://getpost.itgid.info/index2.php?auth=7859d9d42a8834141d529577207c9596&action=3&num1=5&num2=146",
        true
    );
    xhttp.send();
}

function t3_out(data) {
...
function t4() {
    ...
    xhttp.onreadystatechange = function () {
        if (this.readyState === 4 && this.status === 200) {
            t4_out(this.responseText);
        }
    };
    xhttp.open(
        "GET",
        "http://getpost.itgid.info/index2.php?auth=7859d9d42a8834141d529577207c9596&action=4&num1=23&num2=48",
        true
    );
    xhttp.send();
}

function t4_out(data) {
...
function t6() {
    ...
    xhttp.onreadystatechange = function () {
        if (this.readyState === 4 && this.status === 200) {
            t6_out(this.responseText);
        }
    };
    xhttp.open(
        "GET",
        "http://getpost.itgid.info/index2.php?auth=7859d9d42a8834141d529577207c9596&action=6&num1=349&num2=348",
        true
    );
    xhttp.send();
}

function t6_out(data) {
...
function t8() {
    ...
    xhttp.onreadystatechange = function () {
        if (this.readyState === 4 && this.status === 200) {
            t8_out(this.responseText);
        }
    };
    xhttp.open(
        "GET",
        "http://getpost.itgid.info/index2.php?auth=7859d9d42a8834141d529577207c9596&action=8&year=1997",
        true
    );
    xhttp.send();
}

function t8_out(data) {
...
function t9() {
    ...
    xhttp.onreadystatechange = function () {
        if (this.readyState === 4 && this.status === 200) {
            t9_out(this.responseText);
        }
    };
    xhttp.open(
        "GET",
        "http://getpost.itgid.info/index2.php?auth=7859d9d42a8834141d529577207c9596&action=9&y=1",
        true
    );
    xhttp.send();
}

function t9_out(data) {
...
function t12() {
    ...
    xhttp2.onreadystatechange = function () {
        if (this.readyState === 4 && this.status === 200) {
            t12_out(this.responseText);
        }
    };
    xhttp2.open(
        "POST",
        "http://getpost.itgid.info/index2.php?auth=7859d9d42a8834141d529577207c9596&action=3&num1=45&num2=56",
        true
    );
    xhttp2.send();
}

function t12_out(data) {
...
function t15() {
    ...
    xhttp2.onreadystatechange = function () {
        if (this.readyState === 4 && this.status === 200) {
            t15_out(this.responseText);
        }
    };
    xhttp2.open(
        "POST",
        "http://getpost.itgid.info/index2.php?auth=7859d9d42a8834141d529577207c9596&action=6&num3=45&num2=56",
        true
    );
    xhttp2.send();
}

function t15_out(data) {
